...
template <typename T>
constexpr auto erf_inv_ratio_val_1(const T value, const T p, const T deriv1) noexcept -> T
{
...
template <typename T>
constexpr auto erf_inv_halley(const T ratioVal1, const T ratioVal2) noexcept -> T
{
