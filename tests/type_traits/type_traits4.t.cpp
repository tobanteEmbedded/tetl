...
constexpr auto test() -> bool
{
    ...
    CHECK_IS_TRAIT_CV(is_standard_unsigned_integer, unsigned char);
    CHECK_IS_TRAIT_CV(is_standard_unsigned_integer, unsigned short);
    CHECK_IS_TRAIT_CV(is_standard_unsigned_integer, unsigned int);
    CHECK_IS_TRAIT_CV(is_standard_unsigned_integer, unsigned long);
    CHECK_IS_TRAIT_CV(is_standard_unsigned_integer, unsigned long long);
    CHECK_IS_TRAIT_CV(is_standard_unsigned_integer, etl::uint8_t);
    CHECK_IS_TRAIT_CV(is_standard_unsigned_integer, etl::uint16_t);
    CHECK_IS_TRAIT_CV(is_standard_unsigned_integer, etl::uint32_t);
    CHECK_IS_TRAIT_CV(is_standard_unsigned_integer, etl::uint64_t);

    CHECK_IS_TRAIT_CV(is_standard_signed_integer, signed char);
    CHECK_IS_TRAIT_CV(is_standard_signed_integer, signed short);
    CHECK_IS_TRAIT_CV(is_standard_signed_integer, signed int);
    CHECK_IS_TRAIT_CV(is_standard_signed_integer, signed long);
    CHECK_IS_TRAIT_CV(is_standard_signed_integer, signed long long);
    CHECK_IS_TRAIT_CV(is_standard_signed_integer, etl::int8_t);
    CHECK_IS_TRAIT_CV(is_standard_signed_integer, etl::int16_t);
    CHECK_IS_TRAIT_CV(is_standard_signed_integer, etl::int32_t);
    CHECK_IS_TRAIT_CV(is_standard_signed_integer, etl::int64_t);

    CHECK_IS_TRAIT_CV(is_standard_integer, unsigned char);
    CHECK_IS_TRAIT_CV(is_standard_integer, unsigned short);
    CHECK_IS_TRAIT_CV(is_standard_integer, unsigned int);
    CHECK_IS_TRAIT_CV(is_standard_integer, unsigned long);
    CHECK_IS_TRAIT_CV(is_standard_integer, unsigned long long);
    CHECK_IS_TRAIT_CV(is_standard_integer, signed char);
    CHECK_IS_TRAIT_CV(is_standard_integer, signed short);
    CHECK_IS_TRAIT_CV(is_standard_integer, signed int);
    CHECK_IS_TRAIT_CV(is_standard_integer, signed long);
    CHECK_IS_TRAIT_CV(is_standard_integer, signed long long);
    CHECK_IS_TRAIT_CV(is_standard_integer, etl::uint8_t);
    CHECK_IS_TRAIT_CV(is_standard_integer, etl::uint16_t);
    CHECK_IS_TRAIT_CV(is_standard_integer, etl::uint32_t);
    CHECK_IS_TRAIT_CV(is_standard_integer, etl::uint64_t);
    CHECK_IS_TRAIT_CV(is_standard_integer, etl::int8_t);
    CHECK_IS_TRAIT_CV(is_standard_integer, etl::int16_t);
    CHECK_IS_TRAIT_CV(is_standard_integer, etl::int32_t);
    CHECK_IS_TRAIT_CV(is_standard_integer, etl::int64_t);
