...
{
    assert(test_layout_right<etl::uint8_t>());
    assert(test_layout_right<etl::uint16_t>());
    assert(test_layout_right<etl::uint32_t>());
    assert(test_layout_right<etl::uint64_t>());

    assert(test_layout_right<etl::int8_t>());
    assert(test_layout_right<etl::int16_t>());
    assert(test_layout_right<etl::int32_t>());
    assert(test_layout_right<etl::int64_t>());

    assert(test_layout_right<etl::size_t>());
    assert(test_layout_right<etl::ptrdiff_t>());
    return true;
}
