...
[[nodiscard]] constexpr auto operator+(
    chrono::year_month_day_last const& lhs, chrono::months const& rhs) noexcept -> chrono::year_month_day_last
{
...
[[nodiscard]] constexpr auto operator+(
    chrono::months const& lhs, chrono::year_month_day_last const& rhs) noexcept -> chrono::year_month_day_last
{
    return rhs + lhs;
}
...
[[nodiscard]] constexpr auto operator+(
    chrono::year_month_day_last const& lhs, chrono::years const& rhs) noexcept -> chrono::year_month_day_last
{
    return {lhs.year() + rhs, lhs.month_day_last()};
}

[[nodiscard]] constexpr auto operator+(
    chrono::years const& lhs, chrono::year_month_day_last const& rhs) noexcept -> chrono::year_month_day_last
{
    return rhs + lhs;
}
