...
#ifndef TETL_TYPE_TRAITS_IS_NOTHROW_COPY_ASSIGNABLE_HPP
#define TETL_TYPE_TRAITS_IS_NOTHROW_COPY_ASSIGNABLE_HPP
...
template <typename T>
struct is_nothrow_copy_assignable : is_nothrow_assignable<add_lvalue_reference_t<T>, add_lvalue_reference_t<T const>> {
};
...
#endif // TETL_TYPE_TRAITS_IS_NOTHROW_COPY_ASSIGNABLE_HPP
