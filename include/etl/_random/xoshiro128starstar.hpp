...
#ifndef TETL_RANDOM_XORSHIFT128STARSTAR_HPP
#define TETL_RANDOM_XORSHIFT128STARSTAR_HPP
...
struct xoshiro128starstar {
    ...
    explicit constexpr xoshiro128starstar(result_type seed) noexcept : _state {seed} { }
    ...
    [[nodiscard]] friend constexpr auto operator==(
        xoshiro128starstar const& lhs, xoshiro128starstar const& rhs) noexcept -> bool
    {
...
#endif // TETL_RANDOM_XORSHIFT128STARSTAR_HPP
